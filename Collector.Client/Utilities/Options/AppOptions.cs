namespace Collector.Client.Utilities.Options
{
    public class AppOptions
    {
        ...
        public string URLLocalUserService { get; set; } = string.Empty;
